...
| 2 | 📗 [**E-book PDF** — Ultimate Guide to Profiling Unity Games (**75 tr.**)](https://cdn.bfldr.com/S5BC9Y64/at/jmv8gbjf4gc35jptsnmrrsz/Ultimate_Guide_to_Profiling_Unity_Games.pdf) | ✅ ⭐ **Nguồn chính** — toàn văn + **51 ảnh trích từ PDF** (audit 2 bổ sung 40 ảnh). Bổ sung nội dung: công thức *back of the napkin*, 6 preset Marker column, quy trình Remote Frame Debugging, RenderTarget/Depth, shader stage, FTrace/Perfetto, Memory Profiler module đã bị package thay thế |
| 3 | 📗 [**E-book PDF** — Ultimate Guide to Profiling Games, Unity 6 ed. (**93 tr.**)](https://cdn.bfldr.com/S5BC9Y64/at/8t9r5hwz38rrbrw4x8zcq2c/Ultimate_Guide_to_Profiling_Games_e-book_-_Unity_6_edition.pdf) | ⚠️ **Khẳng định “đã đối chiếu 100%” KHÔNG đứng vững** — audit 2 tìm thêm **28 lỗ hổng**, trong đó có **chương Project Auditor** (Unity 6.1, 4 mảng + 3 mức Major/Moderate/Info), danh sách **7 nguyên nhân GPU-bound**, `FrameTimingManager`, `Camera.layerCullDistances`, **GPU Resident Drawer**, `System metrics package`, `File > Build Profiles`, mẹo Profile Analyzer thứ 4, cảnh báo timing tương đối khi deep profiling. Đồng thời **sửa số liệu lỗi thời**: Mali-G78 → **Mali-G710**, Arm Mobile Studio → **Arm Performance Studio**, Arm Graphics Analyzer → **Arm Streamline + Arm Frame Advisor** |
